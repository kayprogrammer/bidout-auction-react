...
const CardListing = ({listing, key}) => {
  ...
  return (
    <Card width='100%' key={key}>
      <CardBody>
        <Box role='button' className='card-img' _hover={{ transform: 'scale(1.05)' }} transitionProperty='all' onClick={() => navigate('/listings/id/')}>
          <Image
            maxW='90%'
            mx='auto'
            src={ listing.image || 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80'}
